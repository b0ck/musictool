...
class MultiProcessing(object):
    ...
    def worker_scanner(self, argument_list=None):
        ...
        while True:
            try:
                ...
                try:
                    function = getattr(self.current_object, self.current_method, None)
    ...
    def init_queue(self, queued_object, method, threads_count=1, arguments=()):
        """
        ...
        if method and queued_object:
            self.current_object = queued_object
